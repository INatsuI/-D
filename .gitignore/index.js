...
bot.on('ready', function() {
    bot.user.setGame("Maître du Bronze | " + (bot.users.size - 1) + " Membre(s) !", "https://www.twitch.tv/Méliodas")
    console.log("Go");
...
bot.on("message", async function(message, result, reject) {
    ...
    if(message.content.startsWith(prefix + "createrole") || message.content.startsWith(prefix + "cr")) {
        ...
        if(!message.guild.members.get(message.author.id).permissions.has('ADMINISTRATOR')) {
            var help_embed = new Discord.RichEmbed()
            .setAuthor("❌ Erreur : ❌")
            .addField("BronzeSécrurité :", "Nivaeu 0")
    ...
    if(message.content.startsWith(prefix + "Hentai")) {
        ...
        if (message.content.startsWith(prefix + "Aide") || message.content.startsWith(prefix + "aide")){
            ...
            var help_embed = new Discord.RichEmbed()
                ...
                .setDescription("🔨 Commandes du bot Maître du Bronze (En Dév)")
                .addField("⛔ Modérateur", "```- M!ban\n- M!kick\n- M!clear\n- M!unban (En dév)\n- M!mute (En dév)\n- M!unmute (En Dév)\n- M!warn (En dév) ```")
                .addField("🔥 Général", "```- M!Support\n- M!invite  ```")
                .addField(":gear: Gestion du serveur", "```- M!createrole  ```")
                .addField("🎉 Fun", "```- M!avatar\n- M!ping\n- M!chat \n- M!Dog\n- M!Invert\n- M!Convmatrix\n- M!Tobecontinued\n- M!Wasted\n- M!Beautiful\n- M!Blood\n- M!Bob\n- M!Triggered\n- M!Illuminati\n- M!Candy```")
                .addField("🎵 Musique", "```- M!play (Lien Youtube) (En Dév)\n- M!skip (En Dév)\n- M!stop (En Dév) ```")
                .addField("💦 NSFW", "```- M!boobs\n- M!4k\n- M!Ass\n- M!Fuck\n- M!Suck\n- M!Kiss ```")
                .setTimestamp()
